...
WINDOW_WIDTH, WINDOW_HEIGHT = 500, 601 # tamaño de la pantalla
GRID_WIDTH, GRID_HEIGHT = 300, 600
TILE_SIZE = 30 # tamaño de la cuadricula
...
def main():
    ...
    ingrese_usuario_text = font.render(
        "Ingrese el usuario", True, (255, 220, 0), bgcolor)  # PERSONALISAMOS
    
    base_font = pygame.font.Font(None, 32)  # PERSONALISAMOS
    user_text = '' 
    input_rect = pygame.Rect(100, 300, 200, 36)
    input_visible = True 
    ...
    while run:
        ...
        if input_visible:
            screen.blit(ingrese_usuario_text, (90, 260))  # posicion del exto PERSONALIZADO 
            pygame.draw.rect(screen, pygame.Color('chartreuse4'), input_rect)
        ...
        if game_over:
            draw_centered_surface(screen, font.render(
        user_text, True, (255, 220, 0), bgcolor), 360)
            draw_centered_surface(screen, score_text, 400)
